...
/// use rfluids::enums::Substance;
///
/// assert_eq!(Substance::from_str("Water"), Ok(Substance::Water));
///
/// // or
///
...
mod tests {
    ...
    #[rstest]
    #[case(Acetone, Pure, "HEOS", None, None)]
    #[case(Air, PseudoPure, "HEOS", None, None)]
    #[case(R729, Pure, "HEOS", None, None)]
    #[case(Ammonia, Pure, "HEOS", None, None)]
    #[case(R717, Pure, "HEOS", None, None)]
    #[case(Argon, Pure, "HEOS", None, None)]
    #[case(R740, Pure, "HEOS", None, None)]
    #[case(Benzene, Pure, "HEOS", None, None)]
    #[case(Butene, Pure, "HEOS", None, None)]
    #[case(CarbonDioxide, Pure, "HEOS", None, None)]
    #[case(R744, Pure, "HEOS", None, None)]
    #[case(CarbonMonoxide, Pure, "HEOS", None, None)]
    #[case(CarbonylSulfide, Pure, "HEOS", None, None)]
    #[case(cis2Butene, Pure, "HEOS", None, None)]
    #[case(Cyclohexane, Pure, "HEOS", None, None)]
    #[case(Cyclopentane, Pure, "HEOS", None, None)]
    #[case(Cyclopropane, Pure, "HEOS", None, None)]
    #[case(D4, Pure, "HEOS", None, None)]
    #[case(D5, Pure, "HEOS", None, None)]
    #[case(D6, Pure, "HEOS", None, None)]
    #[case(Deuterium, Pure, "HEOS", None, None)]
    #[case(Dichloroethane, Pure, "HEOS", None, None)]
    #[case(DiethylEther, Pure, "HEOS", None, None)]
    #[case(DimethylCarbonate, Pure, "HEOS", None, None)]
    #[case(DimethylEther, Pure, "HEOS", None, None)]
    #[case(Ethane, Pure, "HEOS", None, None)]
    #[case(R170, Pure, "HEOS", None, None)]
    #[case(Ethanol, Pure, "HEOS", None, None)]
    #[case(EthylBenzene, Pure, "HEOS", None, None)]
    #[case(Ethylene, Pure, "HEOS", None, None)]
    #[case(R1150, Pure, "HEOS", None, None)]
    #[case(EthyleneOxide, Pure, "HEOS", None, None)]
    #[case(Fluorine, Pure, "HEOS", None, None)]
    #[case(HeavyWater, Pure, "HEOS", None, None)]
    #[case(Helium, Pure, "HEOS", None, None)]
    #[case(R704, Pure, "HEOS", None, None)]
    #[case(HFE143m, Pure, "HEOS", None, None)]
    #[case(RE143a, Pure, "HEOS", None, None)]
    #[case(Hydrogen, Pure, "HEOS", None, None)]
    #[case(R702, Pure, "HEOS", None, None)]
    #[case(HydrogenChloride, Pure, "HEOS", None, None)]
    #[case(HydrogenSulfide, Pure, "HEOS", None, None)]
    #[case(Isobutane, Pure, "HEOS", None, None)]
    #[case(R600a, Pure, "HEOS", None, None)]
    #[case(Isobutene, Pure, "HEOS", None, None)]
    #[case(Isohexane, Pure, "HEOS", None, None)]
    #[case(Isopentane, Pure, "HEOS", None, None)]
    #[case(R601a, Pure, "HEOS", None, None)]
    #[case(Krypton, Pure, "HEOS", None, None)]
    #[case(MD2M, Pure, "HEOS", None, None)]
    #[case(MD3M, Pure, "HEOS", None, None)]
    #[case(MD4M, Pure, "HEOS", None, None)]
    #[case(MDM, Pure, "HEOS", None, None)]
    #[case(Methane, Pure, "HEOS", None, None)]
    #[case(R50, Pure, "HEOS", None, None)]
    #[case(Methanol, Pure, "HEOS", None, None)]
    #[case(MethylLinoleate, Pure, "HEOS", None, None)]
    #[case(MethylLinolenate, Pure, "HEOS", None, None)]
    #[case(MethylOleate, Pure, "HEOS", None, None)]
    #[case(MethylPalmitate, Pure, "HEOS", None, None)]
    #[case(MethylStearate, Pure, "HEOS", None, None)]
    #[case(MM, Pure, "HEOS", None, None)]
    #[case(mXylene, Pure, "HEOS", None, None)]
    #[case(nButane, Pure, "HEOS", None, None)]
    #[case(R600, Pure, "HEOS", None, None)]
    #[case(nDecane, Pure, "HEOS", None, None)]
    #[case(nDodecane, Pure, "HEOS", None, None)]
    #[case(Neon, Pure, "HEOS", None, None)]
    #[case(R720, Pure, "HEOS", None, None)]
    #[case(Neopentane, Pure, "HEOS", None, None)]
    #[case(nHeptane, Pure, "HEOS", None, None)]
    #[case(nHexane, Pure, "HEOS", None, None)]
    #[case(Nitrogen, Pure, "HEOS", None, None)]
    #[case(R728, Pure, "HEOS", None, None)]
    #[case(NitrousOxide, Pure, "HEOS", None, None)]
    #[case(nNonane, Pure, "HEOS", None, None)]
    #[case(nOctane, Pure, "HEOS", None, None)]
    #[case(Novec649, Pure, "HEOS", None, None)]
    #[case(nPentane, Pure, "HEOS", None, None)]
    #[case(R601, Pure, "HEOS", None, None)]
    #[case(nPropane, Pure, "HEOS", None, None)]
    #[case(R290, Pure, "HEOS", None, None)]
    #[case(nUndecane, Pure, "HEOS", None, None)]
    #[case(Orthodeuterium, Pure, "HEOS", None, None)]
    #[case(Orthohydrogen, Pure, "HEOS", None, None)]
    #[case(Oxygen, Pure, "HEOS", None, None)]
    #[case(R732, Pure, "HEOS", None, None)]
    #[case(oXylene, Pure, "HEOS", None, None)]
    #[case(Paradeuterium, Pure, "HEOS", None, None)]
    #[case(Parahydrogen, Pure, "HEOS", None, None)]
    #[case(Propylene, Pure, "HEOS", None, None)]
    #[case(R1270, Pure, "HEOS", None, None)]
    #[case(Propyne, Pure, "HEOS", None, None)]
    #[case(pXylene, Pure, "HEOS", None, None)]
    #[case(R11, Pure, "HEOS", None, None)]
    #[case(R113, Pure, "HEOS", None, None)]
    #[case(R114, Pure, "HEOS", None, None)]
    #[case(R115, Pure, "HEOS", None, None)]
    #[case(R116, Pure, "HEOS", None, None)]
    #[case(R12, Pure, "HEOS", None, None)]
    #[case(R123, Pure, "HEOS", None, None)]
    #[case(R1233zdE, Pure, "HEOS", None, None)]
    #[case(R1234yf, Pure, "HEOS", None, None)]
    #[case(R1234zeE, Pure, "HEOS", None, None)]
    #[case(R1234zeZ, Pure, "HEOS", None, None)]
    #[case(R124, Pure, "HEOS", None, None)]
    #[case(R1243zf, Pure, "HEOS", None, None)]
    #[case(R125, Pure, "HEOS", None, None)]
    #[case(R13, Pure, "HEOS", None, None)]
    #[case(R134a, Pure, "HEOS", None, None)]
    #[case(R13I1, Pure, "HEOS", None, None)]
    #[case(R14, Pure, "HEOS", None, None)]
    #[case(R141b, Pure, "HEOS", None, None)]
    #[case(R142b, Pure, "HEOS", None, None)]
    #[case(R143a, Pure, "HEOS", None, None)]
    #[case(R152a, Pure, "HEOS", None, None)]
    #[case(R161, Pure, "HEOS", None, None)]
    #[case(R21, Pure, "HEOS", None, None)]
    #[case(R218, Pure, "HEOS", None, None)]
    #[case(R22, Pure, "HEOS", None, None)]
    #[case(R227ea, Pure, "HEOS", None, None)]
    #[case(R23, Pure, "HEOS", None, None)]
    #[case(R236ea, Pure, "HEOS", None, None)]
    #[case(R236fa, Pure, "HEOS", None, None)]
    #[case(R245ca, Pure, "HEOS", None, None)]
    #[case(R245fa, Pure, "HEOS", None, None)]
    #[case(R32, Pure, "HEOS", None, None)]
    #[case(R365mfc, Pure, "HEOS", None, None)]
    #[case(R40, Pure, "HEOS", None, None)]
    #[case(R404A, PseudoPure, "HEOS", None, None)]
    #[case(R407C, PseudoPure, "HEOS", None, None)]
    #[case(R41, Pure, "HEOS", None, None)]
    #[case(R410A, PseudoPure, "HEOS", None, None)]
    #[case(R507A, PseudoPure, "HEOS", None, None)]
    #[case(RC318, Pure, "HEOS", None, None)]
    #[case(SES36, Pure, "HEOS", None, None)]
    #[case(SulfurDioxide, Pure, "HEOS", None, None)]
    #[case(R764, Pure, "HEOS", None, None)]
    #[case(SulfurHexafluoride, Pure, "HEOS", None, None)]
    #[case(R846, Pure, "HEOS", None, None)]
    #[case(Toluene, Pure, "HEOS", None, None)]
    #[case(trans2Butene, Pure, "HEOS", None, None)]
    #[case(Water, Pure, "HEOS", None, None)]
    #[case(R718, Pure, "HEOS", None, None)]
    #[case(Xenon, Pure, "HEOS", None, None)]
    #[case(AS10, IncompPure, "INCOMP", None, None)]
    #[case(AS20, IncompPure, "INCOMP", None, None)]
    #[case(AS30, IncompPure, "INCOMP", None, None)]
    #[case(AS40, IncompPure, "INCOMP", None, None)]
    #[case(AS55, IncompPure, "INCOMP", None, None)]
    #[case(DEB, IncompPure, "INCOMP", None, None)]
    #[case(DowJ, IncompPure, "INCOMP", None, None)]
    #[case(DowJ2, IncompPure, "INCOMP", None, None)]
    #[case(DowQ, IncompPure, "INCOMP", None, None)]
    #[case(DowQ2, IncompPure, "INCOMP", None, None)]
    #[case(DSF, IncompPure, "INCOMP", None, None)]
    #[case(HC10, IncompPure, "INCOMP", None, None)]
    #[case(HC20, IncompPure, "INCOMP", None, None)]
    #[case(HC30, IncompPure, "INCOMP", None, None)]
    #[case(HC40, IncompPure, "INCOMP", None, None)]
    #[case(HC50, IncompPure, "INCOMP", None, None)]
    #[case(HCB, IncompPure, "INCOMP", None, None)]
    #[case(HCM, IncompPure, "INCOMP", None, None)]
    #[case(HFE, IncompPure, "INCOMP", None, None)]
    #[case(HFE2, IncompPure, "INCOMP", None, None)]
    #[case(HY20, IncompPure, "INCOMP", None, None)]
    #[case(HY30, IncompPure, "INCOMP", None, None)]
    #[case(HY40, IncompPure, "INCOMP", None, None)]
    #[case(HY45, IncompPure, "INCOMP", None, None)]
    #[case(HY50, IncompPure, "INCOMP", None, None)]
    #[case(NaK, IncompPure, "INCOMP", None, None)]
    #[case(NBS, IncompPure, "INCOMP", None, None)]
    #[case(PBB, IncompPure, "INCOMP", None, None)]
    #[case(PCL, IncompPure, "INCOMP", None, None)]
    #[case(PCR, IncompPure, "INCOMP", None, None)]
    #[case(PGLT, IncompPure, "INCOMP", None, None)]
    #[case(PHE, IncompPure, "INCOMP", None, None)]
    #[case(PHR, IncompPure, "INCOMP", None, None)]
    #[case(PLR, IncompPure, "INCOMP", None, None)]
    #[case(PMR, IncompPure, "INCOMP", None, None)]
    #[case(PMS1, IncompPure, "INCOMP", None, None)]
    #[case(PMS2, IncompPure, "INCOMP", None, None)]
    #[case(PNF, IncompPure, "INCOMP", None, None)]
    #[case(PNF2, IncompPure, "INCOMP", None, None)]
    #[case(S800, IncompPure, "INCOMP", None, None)]
    #[case(SAB, IncompPure, "INCOMP", None, None)]
    #[case(T66, IncompPure, "INCOMP", None, None)]
    #[case(T72, IncompPure, "INCOMP", None, None)]
    #[case(TCO, IncompPure, "INCOMP", None, None)]
    #[case(TD12, IncompPure, "INCOMP", None, None)]
    #[case(TVP1, IncompPure, "INCOMP", None, None)]
    #[case(TVP1869, IncompPure, "INCOMP", None, None)]
    #[case(TX22, IncompPure, "INCOMP", None, None)]
    #[case(TY10, IncompPure, "INCOMP", None, None)]
    #[case(TY15, IncompPure, "INCOMP", None, None)]
    #[case(TY20, IncompPure, "INCOMP", None, None)]
    #[case(TY24, IncompPure, "INCOMP", None, None)]
    #[case(WaterIncomp, IncompPure, "INCOMP", None, None)]
    #[case(XLT, IncompPure, "INCOMP", None, None)]
    #[case(XLT2, IncompPure, "INCOMP", None, None)]
    #[case(ZS10, IncompPure, "INCOMP", None, None)]
    #[case(ZS25, IncompPure, "INCOMP", None, None)]
    #[case(ZS40, IncompPure, "INCOMP", None, None)]
    #[case(ZS45, IncompPure, "INCOMP", None, None)]
    #[case(ZS55, IncompPure, "INCOMP", None, None)]
    #[case(FRE, IncompMassBasedBinaryMixture, "INCOMP", Some(0.19), Some(0.5))]
    #[case(IceEA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.05), Some(0.35))]
    #[case(IceNA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.05), Some(0.35))]
    #[case(IcePG, IncompMassBasedBinaryMixture, "INCOMP", Some(0.05), Some(0.35))]
    #[case(LiBr, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.75))]
    #[case(MAM, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.3))]
    #[case(MAM2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.078), Some(0.236))]
    #[case(MCA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.3))]
    #[case(MCA2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.09), Some(0.294))]
    #[case(MEA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.6))]
    #[case(MEA2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.11), Some(0.6))]
    #[case(MEG, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.6))]
    #[case(MEG2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.56))]
    #[case(MGL, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.6))]
    #[case(MGL2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.195), Some(0.63))]
    #[case(MITSW, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.12))]
    #[case(MKA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.45))]
    #[case(MKA2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.11), Some(0.41))]
    #[case(MKC, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.4))]
    #[case(MKC2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.39))]
    #[case(MKF, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.48))]
    #[case(MLI, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.24))]
    #[case(MMA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.6))]
    #[case(MMA2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.078), Some(0.474))]
    #[case(MMG, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.3))]
    #[case(MMG2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.205))]
    #[case(MNA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.23))]
    #[case(MNA2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.23))]
    #[case(MPG, IncompMassBasedBinaryMixture, "INCOMP", Some(0.0), Some(0.6))]
    #[case(MPG2, IncompMassBasedBinaryMixture, "INCOMP", Some(0.15), Some(0.57))]
    #[case(VCA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.147), Some(0.299))]
    #[case(VKC, IncompMassBasedBinaryMixture, "INCOMP", Some(0.128), Some(0.389))]
    #[case(VMA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.1), Some(0.9))]
    #[case(VMG, IncompMassBasedBinaryMixture, "INCOMP", Some(0.072), Some(0.206))]
    #[case(VNA, IncompMassBasedBinaryMixture, "INCOMP", Some(0.07), Some(0.231))]
    #[case(AEG, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.1), Some(0.6))]
    #[case(AKF, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.4), Some(1.0))]
    #[case(AL, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.1), Some(0.6))]
    #[case(AN, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.1), Some(0.6))]
    #[case(APG, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.1), Some(0.6))]
    #[case(GKN, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.1), Some(0.6))]
    #[case(PK2, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.3), Some(1.0))]
    #[case(PKL, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.1), Some(0.6))]
    #[case(ZAC, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.06), Some(0.5))]
    #[case(ZFC, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.3), Some(0.6))]
    #[case(ZLC, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.3), Some(0.7))]
    #[case(ZM, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.0), Some(1.0))]
    #[case(ZMC, IncompVolumeBasedBinaryMixture, "INCOMP", Some(0.3), Some(0.7))]
    #[case(AirMix, PredefinedMixture, "HEOS", None, None)]
    #[case(Amarillo, PredefinedMixture, "HEOS", None, None)]
    #[case(Ekofisk, PredefinedMixture, "HEOS", None, None)]
    #[case(GulfCoast, PredefinedMixture, "HEOS", None, None)]
    #[case(GulfCoastGasNIST, PredefinedMixture, "HEOS", None, None)]
    #[case(HighCO2, PredefinedMixture, "HEOS", None, None)]
    #[case(HighN2, PredefinedMixture, "HEOS", None, None)]
    #[case(NaturalGasSample, PredefinedMixture, "HEOS", None, None)]
    #[case(R401A, PredefinedMixture, "HEOS", None, None)]
    #[case(R401B, PredefinedMixture, "HEOS", None, None)]
    #[case(R401C, PredefinedMixture, "HEOS", None, None)]
    #[case(R402A, PredefinedMixture, "HEOS", None, None)]
    #[case(R402B, PredefinedMixture, "HEOS", None, None)]
    #[case(R403A, PredefinedMixture, "HEOS", None, None)]
    #[case(R403B, PredefinedMixture, "HEOS", None, None)]
    #[case(R404AMix, PredefinedMixture, "HEOS", None, None)]
    #[case(R405A, PredefinedMixture, "HEOS", None, None)]
    #[case(R406A, PredefinedMixture, "HEOS", None, None)]
    #[case(R407A, PredefinedMixture, "HEOS", None, None)]
    #[case(R407B, PredefinedMixture, "HEOS", None, None)]
    #[case(R407CMix, PredefinedMixture, "HEOS", None, None)]
    #[case(R407D, PredefinedMixture, "HEOS", None, None)]
    #[case(R407E, PredefinedMixture, "HEOS", None, None)]
    #[case(R407F, PredefinedMixture, "HEOS", None, None)]
    #[case(R408A, PredefinedMixture, "HEOS", None, None)]
    #[case(R409A, PredefinedMixture, "HEOS", None, None)]
    #[case(R409B, PredefinedMixture, "HEOS", None, None)]
    #[case(R410AMix, PredefinedMixture, "HEOS", None, None)]
    #[case(R410B, PredefinedMixture, "HEOS", None, None)]
    #[case(R411A, PredefinedMixture, "HEOS", None, None)]
    #[case(R411B, PredefinedMixture, "HEOS", None, None)]
    #[case(R412A, PredefinedMixture, "HEOS", None, None)]
    #[case(R413A, PredefinedMixture, "HEOS", None, None)]
    #[case(R414A, PredefinedMixture, "HEOS", None, None)]
    #[case(R414B, PredefinedMixture, "HEOS", None, None)]
    #[case(R415A, PredefinedMixture, "HEOS", None, None)]
    #[case(R415B, PredefinedMixture, "HEOS", None, None)]
    #[case(R416A, PredefinedMixture, "HEOS", None, None)]
    #[case(R417A, PredefinedMixture, "HEOS", None, None)]
    #[case(R417B, PredefinedMixture, "HEOS", None, None)]
    #[case(R417C, PredefinedMixture, "HEOS", None, None)]
    #[case(R418A, PredefinedMixture, "HEOS", None, None)]
    #[case(R419A, PredefinedMixture, "HEOS", None, None)]
    #[case(R419B, PredefinedMixture, "HEOS", None, None)]
    #[case(R420A, PredefinedMixture, "HEOS", None, None)]
    #[case(R421A, PredefinedMixture, "HEOS", None, None)]
    #[case(R421B, PredefinedMixture, "HEOS", None, None)]
    #[case(R422A, PredefinedMixture, "HEOS", None, None)]
    #[case(R422B, PredefinedMixture, "HEOS", None, None)]
    #[case(R422C, PredefinedMixture, "HEOS", None, None)]
    #[case(R422D, PredefinedMixture, "HEOS", None, None)]
    #[case(R422E, PredefinedMixture, "HEOS", None, None)]
    #[case(R423A, PredefinedMixture, "HEOS", None, None)]
    #[case(R424A, PredefinedMixture, "HEOS", None, None)]
    #[case(R425A, PredefinedMixture, "HEOS", None, None)]
    #[case(R426A, PredefinedMixture, "HEOS", None, None)]
    #[case(R427A, PredefinedMixture, "HEOS", None, None)]
    #[case(R428A, PredefinedMixture, "HEOS", None, None)]
    #[case(R429A, PredefinedMixture, "HEOS", None, None)]
    #[case(R430A, PredefinedMixture, "HEOS", None, None)]
    #[case(R431A, PredefinedMixture, "HEOS", None, None)]
    #[case(R432A, PredefinedMixture, "HEOS", None, None)]
    #[case(R433A, PredefinedMixture, "HEOS", None, None)]
    #[case(R433B, PredefinedMixture, "HEOS", None, None)]
    #[case(R433C, PredefinedMixture, "HEOS", None, None)]
    #[case(R434A, PredefinedMixture, "HEOS", None, None)]
    #[case(R435A, PredefinedMixture, "HEOS", None, None)]
    #[case(R436A, PredefinedMixture, "HEOS", None, None)]
    #[case(R436B, PredefinedMixture, "HEOS", None, None)]
    #[case(R437A, PredefinedMixture, "HEOS", None, None)]
    #[case(R438A, PredefinedMixture, "HEOS", None, None)]
    #[case(R439A, PredefinedMixture, "HEOS", None, None)]
    #[case(R440A, PredefinedMixture, "HEOS", None, None)]
    #[case(R441A, PredefinedMixture, "HEOS", None, None)]
    #[case(R442A, PredefinedMixture, "HEOS", None, None)]
    #[case(R443A, PredefinedMixture, "HEOS", None, None)]
    #[case(R444A, PredefinedMixture, "HEOS", None, None)]
    #[case(R444B, PredefinedMixture, "HEOS", None, None)]
    #[case(R445A, PredefinedMixture, "HEOS", None, None)]
    #[case(R446A, PredefinedMixture, "HEOS", None, None)]
    #[case(R447A, PredefinedMixture, "HEOS", None, None)]
    #[case(R448A, PredefinedMixture, "HEOS", None, None)]
    #[case(R449A, PredefinedMixture, "HEOS", None, None)]
    #[case(R449B, PredefinedMixture, "HEOS", None, None)]
    #[case(R450A, PredefinedMixture, "HEOS", None, None)]
    #[case(R451A, PredefinedMixture, "HEOS", None, None)]
    #[case(R451B, PredefinedMixture, "HEOS", None, None)]
    #[case(R452A, PredefinedMixture, "HEOS", None, None)]
    #[case(R453A, PredefinedMixture, "HEOS", None, None)]
    #[case(R454A, PredefinedMixture, "HEOS", None, None)]
    #[case(R454B, PredefinedMixture, "HEOS", None, None)]
    #[case(R500, PredefinedMixture, "HEOS", None, None)]
    #[case(R501, PredefinedMixture, "HEOS", None, None)]
    #[case(R502, PredefinedMixture, "HEOS", None, None)]
    #[case(R503, PredefinedMixture, "HEOS", None, None)]
    #[case(R504, PredefinedMixture, "HEOS", None, None)]
    #[case(R507AMix, PredefinedMixture, "HEOS", None, None)]
    #[case(R508A, PredefinedMixture, "HEOS", None, None)]
    #[case(R508B, PredefinedMixture, "HEOS", None, None)]
    #[case(R509A, PredefinedMixture, "HEOS", None, None)]
    #[case(R510A, PredefinedMixture, "HEOS", None, None)]
    #[case(R511A, PredefinedMixture, "HEOS", None, None)]
    #[case(R512A, PredefinedMixture, "HEOS", None, None)]
    #[case(R513A, PredefinedMixture, "HEOS", None, None)]
    #[case(TypicalNaturalGas, PredefinedMixture, "HEOS", None, None)]
    ...
    fn substance_from_valid_str_returns_ok(
        ...
        for s in valid_values {
            assert_eq!(Substance::from_str(s), Ok(expected));
            assert_eq!(Substance::try_from(s), Ok(expected));
        }
    }
    ...
    #[case("")]
    #[case("Hello, World!")]
    fn substance_from_invalid_str_returns_err(#[case] invalid_value: &str) {
        assert!(Substance::from_str(invalid_value).is_err());
        assert!(Substance::try_from(invalid_value).is_err());
    }
    ...
    fn substance_category_from_valid_str_returns_ok(
        ...
        assert_eq!(SubstanceCategory::from_str(valid_value), Ok(expected));
        assert_eq!(SubstanceCategory::try_from(valid_value), Ok(expected));
    }

    #[rstest]
    #[case("")]
    #[case("Hello, World!")]
    fn substance_category_from_invalid_str_returns_err(#[case] invalid_value: &str) {
        assert!(SubstanceCategory::from_str(invalid_value).is_err());
        assert!(SubstanceCategory::try_from(invalid_value).is_err());
    }
}
