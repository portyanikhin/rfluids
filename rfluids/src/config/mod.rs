...
declare_config! {
    ...
    ///
    /// **Default:** `false`
    pub henrys_law_to_generate_vle_guesses: bool = false => HenrysLawToGenerateVleGuesses,

    /// If `true`, for mixtures, the molar gas constant _(R)_ will be set to the CODATA value.
    ///
    /// **Default:** `true`
    pub normalize_gas_constants: bool = true => NormalizeGasConstants,
    ...
    ///
    /// **Default:** `false`
    pub overwrite_binary_interaction: bool = false => OverwriteBinaryInteraction,
    ...
    ///
    /// **Default:** `false`
    pub overwrite_departure_fn: bool = false => OverwriteDepartureFn,
    ...
    ///
    /// **Default:** `false`
    pub overwrite_substances: bool = false => OverwriteSubstances,

    /// Starting pressure in `Pa` for phase envelope construction.
    ///
    /// **Default:** `100.0`
    pub phase_envelope_start_pressure_pa: f64 = 100.0 => PhaseEnvelopeStartPressurePa,
    ...
    pub ru_codata: f64 = 8.314_462_618_153_24 => RUCodata,
    ...
    ///
    /// **Default:** `0.5`
    pub spinodal_min_delta: f64 = 0.5 => SpinodalMinDelta,
    ...
    ///
    /// **Default:** `false`
    pub use_guesses_in_props_si: bool = false => UseGuessesInPropsSi,
    ...
    ///
    /// **Default:** `false`
    pub refprop_ignore_error_estimated_interaction_params: bool = false =>
    ...
    ///
    /// **Default:** `false`
    pub refprop_use_gerg: bool = false => RefpropUseGerg,
